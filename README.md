...
You can hear it being the leading effect on Drosophelia's [Instar](https://songwhip.com/drosophelia/instar).
...
See the provided shell scripts. The build output will be stored in `./build/VST3/darvaza.vst3` as well as symbolically linked to your systems VST-plugin folder (on Unix).
...
The Audio Unit component will be located in `./build/bin/Release/Darvaza AUv3.app`
